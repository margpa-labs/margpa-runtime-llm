...
Pre-Git GitHub Preparation            : Next／Detailed Instructions Pending
...
- Basic認証Previewと分離した匿名Public Demo Profile、Rate Limit、Token／Cost保護、Tool／RAG／外部操作遮断
...
したがって、公開文書初版が完成したことを、Phase 1-ex完了、GitHub掲載済み、匿名Demo公開済み、初回Commit済みまたは製品完成と読み替えない。
