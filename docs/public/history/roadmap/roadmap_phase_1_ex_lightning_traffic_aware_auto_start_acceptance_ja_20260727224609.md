...
2026年7月27日時点で、Docs Directory Migration、旧Root退役、Migration Manifest、Rollback Plan、役割権限再整理、Stable／History命名規則、Append-Only運用、設計統括者役Recovery方針、Lightning Basic Preview Lifecycle、Auto-start Stage A／B、Traffic-aware External Wake Acceptanceおよび全Source Inventoryは実施済みである。
...
英語版は今回の日本語正本再構築では作成しない。Phase 1-ex後半で、Current／Publicの全対象について改めて作成有無を判断する。
...
- Corpus全体の最終Link／Identity／Secret／Permission検証
- Public Allowlist／Sanitation
- Mac限定簡易Documentation RAGとExternal Hook
- 匿名Public Demo Profile、Rate Limit、Token／Cost保護
- Git運用設計
- Git初期化、Initial Commit、Remote、Push
- Phase 1-ex Final Lossless Compilation
- Phase 1-ex Final Review、User Acceptance、BackupおよびGitHub公開

したがって、公開文書初版が完成したことを、Phase 1-ex完了、GitHub公開済み、匿名Demo公開済みまたは製品完成と読み替えない。
