...
Phase 2は、元来のConversation／Configuration機能へ着手する前に、`Phase 2-0`としてDocument-driven Orchestration Pilotの設計と最小実行を行う。プロジェクト責任者兼設計統括者役がPhase専用のIndex、開始用Handoff、Reading OrderおよびWrite Authorityを用意し、独立した`Phase 2 設計担当者役`Task等へ直接渡す最初のPilotとする。
