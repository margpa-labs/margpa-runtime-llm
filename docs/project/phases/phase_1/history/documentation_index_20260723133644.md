...
Phase 1-H Accepted Evidence、Current User Manual、Documentation単一Writer、README Roadmap最優先要件およびFuture ML Extensionは、[documentation_index_20260723131846.md](documentation_index_20260723131846.md)から継承する。
