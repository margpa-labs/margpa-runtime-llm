...
snapshot: 20260726154009
state_at: 2026-07-26 15:40:09 JST
status: historical_reconstructed
snapshot_of: ../phase_index_ja.md
supersedes: documentation_index_20260726150349.md
reconstruction_source: margpa-runtime-llm_重複docs削除前_20260726.zip
reconstruction_fidelity: exact_content_with_history_relative_links_rebased
```
...
- Git運用設計と初期化
- 公開Allowlist／Sanitation
- README／LICENSE／NOTICE／CITATION
- Overview／Concept／Roadmap更新
- Local Mac簡易Documentation RAG
- Lightning Hook／再構築確認
- Phase 1-ex Review／Backup／GitHub公開

## 7. History

Phase 1-ex開始時の旧Index、Role TransitionおよびMigration Control Eventは`history/`へ保持する。
