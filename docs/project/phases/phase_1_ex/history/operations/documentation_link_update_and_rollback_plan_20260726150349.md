...
- 状態: `accepted_pre_migration_plan`
...
→ Old Tree Retirement ArtifactまたはPre-migration Sourceから復元
→ Current Indexを旧入口へ戻す
...
本PlanはCopy-first MigrationとRollbackを確定するが、実Copy、Rename、Link Rewrite、Old Tree RetirementまたはDeleteをまだ実行しない。
