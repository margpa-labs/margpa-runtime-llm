...
updated_at: 2026-07-26 21:34:29 JST
owner: 設計統括者役
rag_default: true
```
...
Auto-start Project-side Read-only PreflightとLightning Basic Preview Lifecycle Scriptsは、Repository実装としてAcceptedである。Lightning外部環境、Managed Secrets、Hook、Port、Public URL、Sleep／Wake、Auto-start Platform判定、Public Demo本体、匿名Access、RAGおよびGit操作は未実施・未許可の境界を維持する。
