...
updated_at: 2026-07-27 09:46:39 JST
owner: 設計統括者役
rag_default: true
```
...
3. Current Canonical再構築
4. Phase 1 Lossless再整理
5. Phase 1-ex Interim Lossless再整理
6. Shared再整理
7. Public Docs／README／利用条件／Metadata作成
8. Project Continuity／Roadmap第2周
9. Local Mac簡易Documentation RAG＋External Hook
10. Git運用設計
11. Pre-initial Commit Documentation Refresh
12. 公開Allowlist／Sanitation
13. Git初期化／Initial Commit準備
14. Public Demo最終確認
15. Phase 1-ex Review／Backup／GitHub公開
