...
- 状態: `verified_and_migrated`
- 作成日時: `2026-07-26 15:03:49 JST`
- 更新日時: `2026-07-26 15:33:53 JST`
- Snapshot: `20260726150349`
- 作成担当: 設計統括者役
- 対象: 実Directory Migration前の`docs/`全File
- Machine-readable Manifest: [source_to_target_documentation_migration_manifest_20260726150349.json](source_to_target_documentation_migration_manifest.json)
...
- Preflight: [documentation_migration_preflight_20260726150349.md](documentation_migration_preflight_ja.md)
- 正本言語: 日本語
- supersedes: なし
...
本Inventoryを入力としてCopy-first Migrationを実行した。Raw HistoryのSource SHA-512不一致は0、Mapped Target欠損は0である。

Manifest自身は自己参照Hashを避けるためInventory対象外のままTargetへCopyした。
