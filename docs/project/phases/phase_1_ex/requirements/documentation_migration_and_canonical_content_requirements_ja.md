...
- 状態: `accepted_migration_implemented`
- 作成日時: `2026-07-26 14:54:51 JST`
- 更新日時: `2026-07-26 15:33:53 JST`
- Snapshot: `20260726145451`
- 作成担当: 設計統括者役
- 対象Phase: Phase 1-ex
- Architecture: [phase_1_ex_target_documentation_structure_20260726145451.md](../architecture/target_documentation_structure_ja.md)
...
- Phase 10 Catalog: [phase_10_original_r_and_d_system_catalog_20260721162242.md](../../phase_1/history/governance/phase_10_original_r_and_d_system_catalog_20260721162242.md)
- 正本言語: 日本語
...
本要件に基づくDirectory MigrationとCanonical Set生成を実施した。

Acceptance ConditionsはTarget Validationで確認する。Old Source TreeのRetirement、Delete、Git初期化およびGitHub公開は、本要件の実装完了に含めない。

その後の独立したユーザー許可に基づき、Phase 1-ex原文8件を追加でRaw Historyへ保存し、全320件の非除外SourceについてSHA-512一致を再確認したうえで、旧Rootの重複配置を退役した。原文・開発日誌・Evidenceは削除せず、Phase History／Public Historyに保全している。Git初期化およびGitHub公開は未実施である。
