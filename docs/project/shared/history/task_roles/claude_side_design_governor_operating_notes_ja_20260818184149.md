...
last_updated_at: 2026-08-18 18:41:49 JST
language: ja
provisional: true
...
- Hash Manifestには、第1節の成功／失敗回数・通算何回目か・Before／After Hashの双方を記録する（第1節は簡易参照用、Hash Manifestは詳細記録用という役割分担であり、数値自体は重複記載してよい）。
