...
**背景**：2026-08-18、Chat応答が部分的に英語化する事象、続けて応答全体が丸ごと英語化する事象が連続して発生した（[claude_output_anomaly_language_consistency_ja_20260818025132.md](../history/claude_output_anomaly_language_consistency_ja_20260818025132.md)、[claude_output_anomaly_language_consistency_ja_20260818092418.md](../history/claude_output_anomaly_language_consistency_ja_20260818092418.md)）。後者では、ユーザーが内容を読み取れず、実務上の支障が生じた。原因は特定できていない（前掲2Doc参照）が、再発防止のため、明示的なRuleとして本節を新設する。
