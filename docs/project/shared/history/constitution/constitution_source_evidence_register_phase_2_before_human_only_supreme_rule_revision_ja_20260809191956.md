...
最上位規則群は現時点の列挙で閉じず、Pilot、Incident、Near Missまたは新しいExecution Domainから追加候補を受け入れる。ただし自動採用せず、既存規則とのConflict、検知可能性、違反時動作、Recovery、移植性およびUser Decisionを必要とする。
