...
role_authority_matrix: role_authority_matrix_design_review_passed_user_acceptance_pending
role_view: p2-0-role-view-phase-designer-001_design_review_passed_pending_acceptance
...
existing_task:
  action: deny
read:
  manifest: p2-0-read-manifest-001_receipt-003_candidate_frozen_pending_user_acceptance
