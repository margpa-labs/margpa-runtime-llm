...
updated_at: 2026-08-11 11:05:43 JST
...
16. Role／Docs／Task Artifact規則は通常運転とAutomationで共通化し、Automation側には承認済み到達線と連結実行差分だけを持たせる。
17. Work Unitごとに新規Index／Handoff／Status／Reviewを作成し、全Role間ArtifactへFrom／Toを記録する。
