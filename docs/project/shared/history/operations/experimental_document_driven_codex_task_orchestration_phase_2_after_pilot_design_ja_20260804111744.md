...
現設計統括者役はProject責任者として、Project全体、Cross-Phase不変条件、Task編成、設計Review、実装Handoff、Follow-upおよびRecoveryを統括する。Project責任者であることは、ユーザーの最終Decision Authority、External Mutation Authorityまたは未列挙作業の包括許可を意味しない。また、Project責任者も絶対禁止事項、Docs規則、Authority規則その他の運用ルールから一切免除されない。承認・確認待ちで停止することと、規則を例外扱いすることを混同しない。
