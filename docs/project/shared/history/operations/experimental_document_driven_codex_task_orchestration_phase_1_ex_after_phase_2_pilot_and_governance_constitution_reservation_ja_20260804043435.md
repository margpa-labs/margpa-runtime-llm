...
現設計統括者役はProject責任者として、Project全体、Cross-Phase不変条件、Task編成、設計Review、実装Handoff、Follow-upおよびRecoveryを統括する。Project責任者であることは、ユーザーの最終Decision Authority、External Mutation Authorityまたは未列挙作業の包括許可を意味しない。
